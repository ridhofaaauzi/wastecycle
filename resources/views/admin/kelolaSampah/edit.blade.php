                ...
                <div class="flex-none w-full max-w-full px-3">
                    <div
                        ...
                        <div class="p-6 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                            <h6 class="font-bold" style="font-size: 32px">Edit Sampah</h6>
                        </div>
                        ...
                        <div class="flex-auto px-0 pt-0 pb-2">
                            <div class="p-0 overflow-x-auto">
                                <form class="px-5" action="{{ route('admin.kelolaSampah.update', $waste->id) }}"
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input type="text" name="jenis_sampah" id="jenis_sampah"
                                            ...
                                            placeholder="Masukkan jenis sampah Anda" value="{{ $waste->jenis_sampah }}" />
                                        @error('jenis_sampah')
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input type="number" name="poin" id="poin"
                                            class="bg-gray-50 border border-gray-300 rounded w-full p-2.5"
                                            placeholder="Masukkan poin sampah Anda" value="{{ $waste->poin }}" />
                                        @error('poin')
                                            <div class="text-red-600 mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
