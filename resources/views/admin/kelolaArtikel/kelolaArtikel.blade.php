                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <div class="flex px-2 py-1">
                                                        <div class="flex flex-col justify-center">
                                                            <h6 class="mb-0 text-sm leading-normal">
                                                                {{ implode(' ', array_slice(explode(' ', $post->title), 0, 5)) }}{{ count(explode(' ', $post->title)) > 5 ? '...' : '' }}
                                                            </h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td
                                                    ...
                                                    <span
                                                        class="px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none">{{ $post->user->username }}</span>
                                                </td>
                                                <td
                                                    class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                    <div class="flex justify-center space-x-2">
                                                        <a href="{{ route('admin.kelolaArtikel.edit', $post->id) }}"
                                                        ...
                                                        <form action="{{ route('admin.kelolaArtikel.destroy', $post->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
