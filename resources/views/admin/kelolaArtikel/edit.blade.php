                ...
                <div class="flex-none w-full max-w-full px-3">
                    <div
                        ...
                        <div class="p-6 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                            <h6 class="font-bold" style="font-size: 32px">Edit Artikel</h6>
                        </div>
                        ...
                        <div class="flex-auto px-0 pt-0 pb-2">
                            <div class="p-0 overflow-x-auto">
                                <form class="px-5" action="{{ route('admin.kelolaArtikel.update', $post->id) }}"
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input type="text" id="title" name="title"
                                            ...
                                            placeholder="Masukkan title Anda" value="{{ $post->title }}" />
                                        @error('title')
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <textarea name="content" id="content" cols="30" rows="10"
                                            class="bg-gray-50 border border-gray-300 rounded w-full p-2.5" placeholder="Masukkan content Anda">{{ $post->content }}</textarea>
                                        @error('content')
                                            <div class="text-red-600 mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="mb-5">
                                        ...
                                        <input type="file" id="image" name="image"
                                            class="bg-gray-50 border border-gray-300 rounded w-full p-2.5"
                                            placeholder="Masukkan image Anda" value="{{ $post->image }}" />
                                        @error('image')
                                            <div class="text-red-600 mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
